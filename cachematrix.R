## This code caches the inverse of a matrix using a pair of #functions (1)makeCacheMatrix and (2)cacheSolve. Caching #potentially time-consuming computations helps save time and #resources; avoiding unnecessary recomputations
